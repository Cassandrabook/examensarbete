...
function rara_ecommerce_customize_register_general( $wp_customize ){
    ...
    $wp_customize->add_control(
        ...
        array(
            'section'         => 'instagram_settings',
            'label'           => __( 'Shortcode', 'rara-ecommerce' ),
            'type'            => 'text',
            'description'     => __( 'Add shortcode for your instagram profile below:', 'rara-ecommerce' ),
            'active_callback' => 'rara_ecommerce_instagram_ac',
        )
    ); 
